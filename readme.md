...
## dependencies
[tomlc99](https://github.com/cktan/tomlc99) is [vendored](src/vendor/tomlc99) and statically linked.
[stb_ds](https://github.com/nothings/stb) is [vendored](src/vendor/stb/stb_ds.h) and statically linked.
